...
const UserProfilePage = () => {
    const {user} = useUser();
    const userAvatar = '/user-default.svg';
    return (
        <div className="mx-auto w-full max-w-md px-8 py-4 mt-8 mb-10 bg-white rounded-lg shadow-lg dark:bg-gray-800">

            <div className="relative overflow-hidden">
                <Img className="object-cover w-full h-48" src={userAvatar} alt="avatar" />
                    ...
                    <div className="flex items-center px-6 py-3 bg-gray-800">
                        ...
                        <h1 className="mx-3 text-lg font-semibold text-white">Profile Details</h1>
                    </div>

                    <div className="px-6 py-4">
                    <h1 className="text-xl font-semibold text-gray-700 dark:text-white">{user?.firstName} {user?.lastName}</h1>

                        <p className="py-2 text-gray-700 dark:text-gray-400">UI / UX Designer</p>
                        ...
                        <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                            ...
                            <h1 className="px-2 text-sm">Singapore</h1>
                        </div>
                        ...
                        <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                            ...
                            <h1 className="px-2 text-sm">{ user?.primaryEmailAddress?.emailAddress }</h1>
